...
public sealed class ToolDiscoveryService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        try
        {
            ...
            // T091: Load OpenMeteo assembly for tool discovery
            // Use Assembly.Load to avoid direct type reference (tools are now internal)
            _ = Assembly.Load("LocalAIAgent.OpenMeteo");
            ...
            foreach (var assembly in assemblies)
            {
                ...
                if (assembly.FullName?.StartsWith("System") == true ||
                    ...
                    !assembly.FullName.Contains("LocalAIAgent"))
                {
                    continue;
                }
