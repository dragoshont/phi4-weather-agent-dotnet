...
{
    [Fact(Skip = "External API integration - field names changed, run manually to verify current format")]
    ...
    [Fact(Skip = "External API integration - run manually to verify current behavior")]
    ...
    [Fact(Skip = "External API integration - error message format may vary, run manually to verify")]
    ...
    [Fact(Skip = "External API integration - error handling varies, run manually to verify")]
