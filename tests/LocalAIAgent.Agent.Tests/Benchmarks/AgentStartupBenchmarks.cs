...
namespace LocalAIAgent.Agent.Tests.Benchmarks;

/// <summary>
/// T066: BenchmarkDotNet performance harness for agent operations
/// Run with: dotnet run -c Release --project tests/LocalAIAgent.Agent.Tests
/// 
/// TODO T066: Uncomment BenchmarkDotNet using statements and add package reference:
/// dotnet add tests/LocalAIAgent.Agent.Tests package BenchmarkDotNet --version 0.14.0
/// </summary>
// [MemoryDiagnoser]
...
/// Usage: dotnet run -c Release --project tests/LocalAIAgent.Agent.Tests -- --filter *AgentStartup*
/// </summary>
...
//         Console.WriteLine("Run with: dotnet run -c Release --project tests/LocalAIAgent.Agent.Tests");
//         Console.WriteLine("Add package: dotnet add tests/LocalAIAgent.Agent.Tests package BenchmarkDotNet --version 0.14.0");
//     }
// }
